...
from .src.train_utils import (
    train_representations_learner,
)

sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "../")))
from simulations.config import params
from simulations.simulation import generate_simulation

from .src.evaluate import run_att_experiment
...
def main(
    ...
    val_loader = make_loader(datasets, configs, "val", batch_size, drop_last=False)
