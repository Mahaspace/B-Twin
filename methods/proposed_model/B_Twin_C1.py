...
from .src.ablation import run_att_experiment, train_representations_learner_C1
from .src.config import (
    DEVICE,
)
from .src.data_format import make_loader
from .src.data_preperation import prepare_data
from .src.model import CausalInferenceModelWithoutPropensity
...
def main(
    ...
    model = CausalInferenceModelWithoutPropensity(
    ...
    t1 = time.time()
    best_model, history = train_representations_learner_C1(
    ...
    ## run att experiment : train the second bloc and estimate att
